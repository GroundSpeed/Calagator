...
- (NSMutableDictionary*)options
{
	if (_options == nil) {
		_options = [[NSMutableDictionary alloc]
					...
					AMOptionsHeaderFont : [UIFont fontWithName:@"Gill Sans" size:13],
					...
					AMOptionsCellFont : [UIFont fontWithName:@"Gill Sans" size:14],
					AMOptionsCellBadgeFont : [UIFont fontWithName:@"Gill Sans" size:12],
...
- (void)loadView
{
    ...
    self.contentController.navigationBar.tintColor = [UIColor colorWithRed:12.0f/255.0f green:73.0f/255.0f blue:100.0f/255.0 alpha:1.0];
